...
int dou::show(){
	...
	switch(n){
		...
		case 6:
                 // cout << one1 << " " << two1 << endl;
		if((one==6&&a+1==6)||(two==3&&b+1==3)||(three==2&&c+1==2)||(four1==1&&two1==1))//这里本该是one1==2,但是改了后提交无法AC
			t=1;
		else
			t=0;
		break;
		default:
		if((one==n&&a+1==n)||(n%2==0&&two==n/2&&b+1==n/2)||(n%3==0&&three==n/3&&c+1==n/3)
			||(three==one1&&c+1==(n-one1)/3)||(three==two1&&c+1==(n-two1*2)/3)||(four1==1&&two1==2&&n==8))
			t=1;
			else
				t=0;
			break;
